...
/**
 * ArId por hbm2java el 10/07/2016 07:32:40 PM - Hibernate Tools 3.2.4.GA
 */
@Embeddable

public class ArId  implements java.io.Serializable
 {
    ...
    public ArId(Integer id, String invnumber, Date transdate, Integer customerId, Boolean taxincluded, Double amount, Double netamount, Double paid, Date datepaid, Date duedate, Boolean invoice, String shippingpoint, Short terms, String notes, String curr, String ordnumber, Integer employeeId, String till, String quonumber, String intnotes, Integer departmentId, String shipvia, String languageCode, String ponumber, Boolean approved, Float cashdiscount, Short discountterms, String waybill, Integer warehouseId, String description, Boolean onhold, Double exchangerate, String dcn, Integer bankId, Integer paymentmethodId, Integer tipodocId, Integer ticketId) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ArId) ) return false;
		 ArId castOther = ( ArId ) other; 
