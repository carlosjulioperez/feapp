...
/**
 * DptTransId por hbm2java el 10/07/2016 07:32:40 PM - Hibernate Tools 3.2.4.GA
 */
@Embeddable

public class DptTransId  implements java.io.Serializable
 {
    ...
    public DptTransId(Integer transId, Integer departmentId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DptTransId) ) return false;
		 DptTransId castOther = ( DptTransId ) other; 
