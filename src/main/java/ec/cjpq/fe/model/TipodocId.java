...
/**
 * TipodocId por hbm2java el 10/07/2016 07:32:40 PM - Hibernate Tools 3.2.4.GA
 */
@Embeddable
...
public class TipodocId  implements java.io.Serializable
 {
    ...
    public TipodocId(int id) {
        this.id = id;
    }
    public TipodocId(int id, String description, String code) {
       this.id = id;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TipodocId) ) return false;
		 TipodocId castOther = ( TipodocId ) other; 
